jindo.Component = jindo.$Class({
        ...
        _onMouseUp: function(t) {
            var e, n, i, s = t.element,
                a = [],
                o = this._aDownedElements;
            for (i = 0; n = o[i]; i++) a.push({
                element: n,
                htStatus: this.option("htStatus"),
                weEvent: t
            });
        ...
        draw: function(t, e, n) {
            ...
            if (this.fireEvent("beforeDraw", {
                ...
                if (this._aDateElement = jindo.$$("." + i + "date", this.elWeekAppendTarget), this._aDateContainerElement = jindo.$$("." + i + "week > *", this.elWeekAppendTarget), v > 0)
        ...
        slideUp: function(t) {
            ...
            return this._hide(function() {
                ...
                i.getVisible() && i._fireEventBeforeHide() && (n = Math.ceil(n * (i._wel.height() / i._nLayerHeight)), e.attach({
                        ...
                        }), this.detach("end", arguments.callee), i._fireEventHide()
                    }
                }).start(n, {
                    getter: function(e) {
        ...
        _onEvent: function(t) {
            ...
            this._oEventTimer.start(function() {
                ...
                }), n._oHideTimer.abort(), n._bIsHiding = !1) : "undefined" != typeof e.tagName && n.hide())
        ...
        getPosition: function(t) {
            ...
            var e, n = this._isPosition(t, "center"),
                ...
                if ("task" == t.sType)
                    for (var e = t.aList, n = 0, i = e.length; i > n; n++)
                        for (var s = e[n].elTarget, a = 0, o = e[n].aValue, r = o.length; r > a; a++) {
                            var h = o[a][0],
                                l = o[a][2];
                            if ("function" != typeof l && (l = l instanceof Array ? this.option("fEffect")(l[0], l[1]) : this.option("fEffect")(l)), l.setStart)
    ...
    function() {
        ...
        upload: function() {
            ...
            this.constructor._oCallback[i + "_success"] = jindo.$Fn(function(t) {
                this.option("bAutoReset") && this.reset(), this._revertFormAttr(), this.fireEvent("success", {
                    htResult: t
                }), this._clear()
            }, this).bind(), this.constructor._oCallback[i + "_error"] = jindo.$Fn(function(t) {
                this.option("bAutoReset") && this.reset(), this._revertFormAttr(), this.fireEvent("error", {
                    htResult: t
                }), this._clear()
            }, this).bind(), t.submit()
        },
        ...
        _checkExtension: function(t) {
            for (var e, n = this.option("sFiletype").split(";"), i = 0; i < n.length; i++)
                if (e = "*.*" == n[i] ? "*" : n[i], e = e.replace(/^\s+|\s+$/, ""), e = e.replace(/\./g, "\\."), e = e.replace(/\*/g, "[^\\/]+"), new RegExp(e + "$", "gi").test(t)) return !0;
            return !1
        },
        ...
        _complete: function() {
            var t, e = this._aResponse.concat(),
                n = {};
            for (t in this._htMetaData) n[t] = this._htMetaData[t];
            this._reset(), this.fireEvent("complete", {
                aResponse: e,
                htMetaData: n
            })
        }
        ...
        movePageTo: function(t, e) {
            "undefined" == typeof e && (e = !0), t = this._convertToAvailPage(t), this._nCurrentPage = t, (!e || this.fireEvent("beforeMove", {
                nPage: t
            })) && (this._paginate(t), e && this.fireEvent("move", {
                nPage: t
            }))
        },
        reset: function(t) {
        ...
        _paginate: function(t) {
            ...
            for (var p, v, m = d; _ >= m; m++) m == t ? p = jindo.$(jindo.$Template(e.sCurrentPageTemplate).process({
                page: m.toString()
            })) : (p = jindo.$(jindo.$Template(e.sPageTemplate).process({
                page: m.toString()
            })), this._waPage.push(p)), v = jindo.$Element(p), m == d && v.addClass(this._wrapPrefix(this.option("sClassFirst"))), m == _ && v.addClass(this._wrapPrefix(this.option("sClassLast"))), this._welPageList.append(p), this._addTextNode();
        ...
        getDatePickerSet: function(t) {
            ...
            for (var e = 0, n = this._aDatePickerSet.length; n > e; e++)
                if (this._aDatePickerSet[e].elInput == t || this._aDatePickerSet[e].elButton == t) return this._aDatePickerSet[e];
            return !1
        },
        ...
        _onClickLinkedElement: function(t) {
            if (t.stop(jindo.$Event.CANCEL_DEFAULT), this.fireEvent("click", {
                    element: t.element
                })) {
        ...
        setValue: function(t, e) {
            ...
            return i = Math.min(i, this._nBaseWidth), this._welRatingElement.width(i), this._nValue = t, e && this.fireEvent("set", {
                nValue: this._nValue
            }), this
        },
        reset: function() {
        ...
        _onMouseUp: function(t) {
            ...
            var e = this._htDragInfo;
            e.bHandleDown = !1, this.fireEvent("handleUp", {
                weEvent: t,
                elHandle: e.elHandle,
                elDrag: e.elDrag
            })
        ...
        if ("function" != typeof e && (e = function() {}), this._queueCallback(t, e), this._checkIsLoading(t)) return !1;
