...
"undefined" != typeof window && "undefined" == typeof window.nhn && (window.nhn = {}), "undefined" != typeof window ? "undefined" == typeof window.jindo && (window.jindo = {}) : jindo || (jindo = {}), jindo.$Jindo = function() {
        ...
        old_cssquery = function(e, t, n) {
            ...
            for (var r, s = (new Date).getTime(), a = 0, u = debugOption.repeat; u > a; a++) r = function(e, t, n) {
                if (n ? n.oneTimeOffCache || (n.oneTimeOffCache = !1) : n = {
                        oneTimeOffCache: !1
                    }, cssquery.safeHTML(n.oneTimeOffCache), t || (t = document), oDocument_dontShrink = t.ownerDocument || t.document || t, /\bMSIE\s([0-9]+(\.[0-9]+)*);/.test(navigator.userAgent) && parseFloat(RegExp.$1) < 6) {
                    try {
    ...
    try {
        ...
        else t.edge ? n = i.match(/(?:Edge)\/([\d.]+)/)[1] : t.safari || t.msafari ? (n = parseFloat(i.match(/Safari\/([0-9.]+)/)[1]), n = 100 == n ? 1.1 : i.match(/Version\/([0-9.]+)/) ? RegExp.$1 : [1, 1.2, -1, 1.3, 2, 3][Math.floor(n / 100)]) : t.mopera ? n = i.match(/(?:Opera\sMini)\/([0-9.]+)/)[1] : t.firefox || t.opera || t.omniweb ? n = i.match(/(?:Firefox|Opera|OmniWeb)\/([0-9.]+)/)[1] : t.mozilla ? n = i.match(/rv:([0-9.]+)/)[1] : t.icab ? n = i.match(/iCab[ \/]([0-9.]+)/)[1] : t.chrome && (n = i.match(/Chrome[ \/]([0-9.]+)/)[1]);
    ...
    var e = new Object,
        ...
        o = null;
    if (e.installed = !1, e.version = -1, "undefined" != typeof t && t.length) o = t["Shockwave Flash"], o && (e.installed = !0, o.description && (e.version = parseFloat(o.description.match(/[0-9.]+/)[0]))), t["Shockwave Flash 2.0"] && (e.installed = !0, e.version = 2);
    else if ("undefined" != typeof n && n.length) o = n["application/x-shockwave-flash"], e.installed = o && o.enabledPlugin;
    else
    ...
    var e = new Object,
        t = this._navigator.plugins,
        n = null;
    if (e.installed = !1, e.version = -1, "undefined" != typeof t && t.length) n = t["Silverlight Plug-In"], n && (e.installed = !0, e.version = parseInt(n.description.split(".")[0], 10), "1.0.30226.2" == n.description && (e.version = 2));
    else try {
    ...
    if (r.postBody && "XHR" == l && "GET" != d) t = "string" == typeof e ? e : jindo.$Json(e).toString();
    ...
    _getCallbackInfo: function() {
        ...
        if ("" != this.option("callbackid")) {
            ...
            do e = "_" + Math.floor(1e4 * Math.random()); while (window.__jindo2_callback[e]);
    ...
    send: function(e) {
        ...
        var r = "&"; - 1 == this._url.indexOf("?") && (r = "?"), e = e ? "&" + e : "", this._test_url = this._url + r + n.callbackname + "=" + n.name + e, this._script.src = this._url + r + n.callbackname + "=" + n.name + e
    }
    ...
    for (var n in this._table)
        if (this._table.hasOwnProperty(n))
            if ("object" == typeof(t = this._table[n]) && t.constructor == Array)
                for (i = 0; i < t.length; i++) e[e.length] = encodeURIComponent(n) + "[]=" + encodeURIComponent(t[i] + "");
            ...
            if ("string" == typeof t && t)
                if ("/" != t.substr(0, 1)) {
                    var h = "string" == typeof n && n,
                        y = "string" == typeof i && i,
                        m = !h && y ? "" : {};
                    if (c = r.stack[f], "undefined" == typeof c[t]) c[t] = m, c = r.stack[f + 1] = c[t];
    ...
    for (var t, n, o, i, r, s = this._object, a = e.split("/"), u = /^([\w:\-]+)\[([0-9]+)\]$/, l = [
            [s]
        ], d = l[0], c = a.length, p = 0; c > p; p++)
        if ("." != a[p] && "" != a[p]) {
            if (".." == a[p]) l.length--;
            else {
        ...
        switch (typeof t) {
            ...
            case "object":
                ...
                if (t instanceof Array)
                    for (var r = t.length, s = 0; r > s; s++) i += e(t[s], n);
                else {
                    var a = "";
                    for (var u in t)
...
jindo.$Element.prototype.$value = function() {
    ...
    if ("undefined" != typeof p && e instanceof p && (e = e._table), "object" == typeof e) {
        ...
        for (var y in e)
            if (e.hasOwnProperty(y)) {
                ...
                if ("cssFloat" == y && IS_IE && (y = "styleFloat"), !IS_FF && !IS_OP || "backgroundPositionX" != y && "backgroundPositionY" != y) this._setCss(n, y, f);
                else {
    ...
    if ("undefined" != typeof jindo.$H && e instanceof jindo.$H && (e = e.$value()), "object" == typeof e)
        for (var i in e) e.hasOwnProperty(i) && ("undefined" != typeof t && null === t ? n.removeAttribute(i) : "class" == i || "className" == i ? n.className = e[i] : "style" == i ? n.style.cssText = e[i] : "checked" == i || "disabled" == i ? n[i] = e[i] : "value" == i ? n.value = e[i] : n.setAttribute(i, e[i]));
    return this
    ...
    return document.compareDocumentPosition ? jindo.$Element._contain = function(e, t) {
        ...
        for (var n = e, o = t; n && n.parentNode;)
            if (n = n.parentNode, n == o) return !0;
        return !1
    ...
    function o(e, t) {
        ...
        if (t) switch (t.button = 0 + (t.middle ? 1 : 0) + (t.right ? 2 : 0), t.ctrl = t.ctrl || !1, t.alt = t.alt || !1, t.shift = t.shift || !1, t.meta = t.meta || !1, n) {
            case "MouseEvent":
                ...
                break;
            case "KeyboardEvent":
                if (window.KeyEvent) o = document.createEvent("KeyEvents"), o.initKeyEvent(e, !0, !0, window, t.ctrl, t.alt, t.shift, t.meta, t.keyCode, t.keyCode);
                else try {
    ...
    var r = e._element;
    if (r.insertAdjacentHTML && !/^<(option|tr|td|th|col)(?:.*?)>/.test(t.replace(/^(\s|　)+|(\s|　)+$/g, "").toLowerCase())) r.insertAdjacentHTML(n, t);
    else {
        var s, a = r.ownerDocument || r.document || document,
    ...
    if (!this._element["_delegate_" + e]) {
        ...
        var o = jindo.$Fn(function(e, t) {
            ...
            var n, o, i, r, s = t.target || t.srcElement,
...
if (jindo.$Fn.prototype.$value = function() {
        ...
        if ("undefined" == typeof r.addEventListener || jindo.$Fn._resizeEventBugInIE(t)) {
            ...
            else if ("mousewheel" == i && s.indexOf("WebKit") < 0 && !/Opera/.test(s) && !u) i = "DOMMouseScroll";
        ...
        if ("undefined" == typeof e ? t = !1 : e.constructor == Number ? (t = !0, n = e) : e.constructor == Object ? (a = e.charset || a, n = e.size || !1, t = !!n) : t = !1, "utf-8" == a.toLowerCase()) {
            for (r = 0; s > r; r++)
                if (o = this._str.charCodeAt(r), i += 128 > o ? 1 : 2048 > o ? 2 : 65536 > o ? 3 : 4, t && i > n) {
        ...
        if (0 == n) jindo.$A(this.element()).forEach(function(e) {
            ...
            for (var i = 0; n > i; i++) o(arguments[i]);
                ...
                switch (e.type) {
                    ...
                    case "select-multiple":
                        ...
                        if (o.constructor == Array)
                            for (var r = jindo.$A(o), n = 0, i = e.options.length; i > n; n++) e.options[n].selected = r.has(e.options[n].value);
                        else {
            ...
            switch (e.type) {
                ...
                case "select-multiple":
                    if (-1 != e.selectedIndex)
                        for (var t = 0, n = e.options.length; n > t; t++) e.options[t].selected && i.push(e.options[t].value);
                    break;
                default:
                    i.push(e.value)
            }
