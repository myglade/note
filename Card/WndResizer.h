...
#define WM_RESIZER_UNHOOK	(WM_USER+99)
#define WM_RESIZER_SIZE		(WM_USER+100)
#define WM_RESIZER_PORTION_CHANGE (WM_USER+101)
...
public:
  ...
  BOOL IsHooked() { return m_pHookedWnd != NULL; }
private:
  ...
  void OnSizeProc(UINT nType, int cx, int cy);
